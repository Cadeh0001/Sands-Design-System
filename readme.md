...
- **Comp tables:** subject rows pinned to the top with the orange tint, average/total row bold over a 3px navy rule, em dashes for missing fields. Order on-market comps by days on market ascending unless told otherwise.
