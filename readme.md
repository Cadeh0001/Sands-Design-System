...
- `slides/` — the full 37-slide bank as standalone HTML templates (cards + starting points): cover, agenda, 6 section dividers, market conditions, comps, asset formats, options grid, offering, tenant overview, value drivers, lease abstract, on-market + sold comps, valuation summary, sensitivity, pricing matrix, 1031 timeline, buy box, exchange economics, income replacement, replacement scenarios, track record, buyer universe, case study (2), selected transactions, bidding process, retail execution timeline, summary, ask, team, confidentiality
